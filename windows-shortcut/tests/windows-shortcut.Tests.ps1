Describe 'windows-shortcut' {
    ...
    Context 'Discovery' {
        ...
        It 'should have a valid manifest' {
            $manifest = Get-Content (Join-Path $publishPath 'windows-shortcut.dsc.resource.json') | ConvertFrom-Json
            $manifest.type | Should -Be 'OpenDsc.Windows/Shortcut'
